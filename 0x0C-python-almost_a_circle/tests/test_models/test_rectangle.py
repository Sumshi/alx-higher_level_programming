...
class TestRectangle_instantiation(unittest.TestCase):
    ...
    def test_rectangle_is_base(self):
        """checks whether rectangle is an instance of base class"""
        self.assertIsInstance(Rectangle(10, 5), Base)

    def test_no_args(self):
        """checks if error will be raised if passed no args"""
        with self.assertRaises(TypeError):
            Rectangle()

    def test_one_arg(self):
        """checks if error will be raised if passed 1 args"""
        with self.assertRaises(TypeError):
            Rectangle(1)

    def test_two_args(self):
        """checks if id attribute has been assingned correctly"""
        r1 = Rectangle(10, 5)
        r2 = Rectangle(5, 10)
    ...
    def test_three_args(self):
        """checks if id attribute has been assingned correctly"""
        r1 = Rectangle(20, 20, 40)
        r2 = Rectangle(40, 40, 20)
        self.assertEqual(r1.id, r2.id - 1)
    ...
    def test_five_args(self):
        """checks if id attribute has been assingned correctly"""
        self.assertEqual(20, Rectangle(10, 5, 0, 0, 20).id)

    def test_more_than_five_args(self):
        """rectangle has only id,width,height,x,y"""
        with self.assertRaises(TypeError):
            Rectangle(1, 2, 3, 4, 5, 6)

    def test_width_private(self):
        """checks whether Rectangle has private attribute named _width"""
        with self.assertRaises(AttributeError):
            print(Rectangle(4, 5, 0, 0, 1).__width)

    def test_height_private(self):
        """checks whether Rectangle has private attribute named _height"""
        with self.assertRaises(AttributeError):
            print(Rectangle(4, 5, 0, 0, 1).__height)

    def test_x_private(self):
        """checks whether Rectangle has private attribute named __x"""
        with self.assertRaises(AttributeError):
            print(Rectangle(4, 5, 0, 0, 1).__x)

    def test_y_private(self):
        """checks whether Rectangle has private attribute named __y"""
        with self.assertRaises(AttributeError):
            print(Rectangle(4, 5, 0, 0, 1).__y)

    def test_width_getter(self):
        """ checks the getter method for the width attribute"""
        r = Rectangle(6, 5, 4, 3, 2)
        self.assertEqual(6, r.width)

    def test_width_setter(self):
        """checks the setter method for the width attribute """
        r = Rectangle(6, 5, 4, 3, 2)
        r.width = 10  # updates the value of width to 10
